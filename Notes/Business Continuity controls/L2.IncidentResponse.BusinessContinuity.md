...
### Components in Business Continuity Plan (BCP)
* BRP (Business Recovery Plan): steps to take to restore nomral business operations after recovering
* Continuity of Support Plan: support of specific IT systems and applications
* CMP (Crisis Management Plan): coordination among management in the event of an emergency or disruptive event
* Crisis Communications Plan (Subplan from CMP): internal and external communication during a disaster

### BCP Framework (NIST 800-34)
